...
export const ExecutingAgency = (props) => {
  return (
    <div id="features" className="text-center py-12">
      <div className="container">
        ...
        <div className="w-11/12 m-auto my-6 tracking-normal font-normal text-14 leading-[100px] mb-[39px]">
          ...
          <p className="leading-[38px] mt-8 text-justify">The Federal Government of Nigeria appointed the Bank of Industry (BOI) to serve as the Executing Agency for the i-DICE program. As the largest and most successful Development Finance Institute (DFI), in the country, BOI is responsible for the coordination and supervision of i-DICE from inception till execution. The selection of BOI as the Executing Agency is based on its experience in implementing and operating similar FGN programs and its credit worthiness with a Long-Term National Rating of AA+ by Fitch (2020).</p>
        </div>
      </div>
    </div>
  );
